...
@interface VRVIUMPlayerLocalFileViewController ()

@end

@implementation VRVIUMPlayerLocalFileViewController {
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    switch (indexPath.section) {
        case 0: {
            ...
            VRVIUMPlayerLocalFileViewController *viewController = [[VRVIUMPlayerLocalFileViewController alloc] initWithFolderPath:fileName];
        ...
        case 1: {
            ...
            [VRVIUVideoPlayerViewController presentFromViewController:self withTitle:[NSString stringWithFormat:@"File: %@", fileName] URL:[NSURL fileURLWithPath:fileName] completion:^{
            }];
